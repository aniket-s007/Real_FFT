...
module tb_top_stage1_stage2_stage3_stage4;
    ...
    parameter WIDTH = 16;
    parameter TWIDDLE_WIDTH = 14;   // twiddle coefficient bit-width, independent of WIDTH
    ...
    top_stage1_stage2_stage3_stage4 #(.WIDTH(WIDTH), .TWIDDLE_WIDTH(TWIDDLE_WIDTH)) dut (
